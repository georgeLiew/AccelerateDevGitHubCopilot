...
public class JsonData
{
    ...
    public Loan GetPopulatedLoan(Loan l)
    {
        return new Loan
        {
            ...
            DueDate = l.DueDate,
            ReturnDate = l.ReturnDate,
            BookItem = BookItems == null
                ? null
                : GetPopulatedBookItem(BookItems.Single(bi => bi.Id == l.BookItemId)),
            Patron = Patrons == null
                ? null
                : Patrons.Single(p => p.Id == l.PatronId)
        };
    }
    ...
    public BookItem GetPopulatedBookItem(BookItem bi)
    {
        return new BookItem
        {
            ...
            Book = Books == null
                ? null
                : GetPopulatedBook(Books.Single(b => b.Id == bi.BookId))
        };
    }
    ...
    public Book GetPopulatedBook(Book b)
    {
        return new Book
        {
            ...
            Author = Authors == null
                ? null
                : Authors.Where(a => a.Id == b.AuthorId)
